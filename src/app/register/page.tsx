    ...
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-0 bg-white shadow-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-[#5D4037] mt-4">계정 만들기</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-[#33691E] hover:bg-[#1B5E20] mt-2" disabled={isLoading}>
              {isLoading ? (
                <>
